...
<div id="pnlOnly">
    <div id="graLeft">
		<iframe src="charts/estrusore/estr_pressure_trend.jsp" frameborder="0" scrolling="No" height="350px" width="750px">
		</iframe>
    </div>
    <div id="graRight">
		<iframe src="charts/estrusore/estr_pressure_current.jsp" frameborder="0" scrolling="No" height="350px" width="350px">
		</iframe>
    </div>
</div>
</div>
...
<div id="pnlOnly">
    <div id="graLeft">
		<iframe src="charts/estrusore/estr_energy_trend.jsp" frameborder="0" scrolling="No" height="350px" width="750px">
		</iframe>
    </div>
    <div id="graRight">
		<iframe src="charts/estrusore/estr_energy_current.jsp" frameborder="0" scrolling="No" height="350px" width="350px">
		</iframe>
    </div>
</div>
</div>
