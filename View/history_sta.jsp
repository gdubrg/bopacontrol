<html>
	...
	<body>
		...
		<%	
			...
			String query = "SELECT DISTINCT(DATE(data)) FROM stampo";
		...
		<div class="dropdown">
		 ...
		 <ul class="dropdown-menu">
			...
			for(int i=0; i<days.size(); ++i)
				...
				"<button type=\"submit\" name=\"storico_sta\" class=\"btn btn-primary btn-xs\">"+days.get(i)+"</button>"+
		...
		<!-- Check degli allarmi -->
		<iframe src="charts/stampo/sta_history_chart.jsp" frameborder="0" scrolling="No" height="610px" width="1290px"></iframe>
	</body>
</html>
